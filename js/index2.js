...
//btnClickSound.addEventListener('ended', function() { btnClickSound.play(); });

var cardSlideSound = new Audio();
cardSlideSound.src = "audio/CardSlide.mp3";
//cardSlideSound.addEventListener('ended', function() { cardSlideSound.play(); });

var menuOpenSound = new Audio();
menuOpenSound.src = "audio/MenuOpen.mp3";
//menuOpenSound.addEventListener('ended', function() { menuOpenSound.play(); });

var menuCloseSound = new Audio();
menuCloseSound.src = "audio/MenuClose.mp3";
//menuCloseSound.addEventListener('ended', function() { menuCloseSound.play(); });
